...
function buildConfig(env = process.env) {
  ...
  return {
    ...
    chromeAutoStart: readBooleanEnv(env, 'CHROME_AUTO_START', false),
    chromePath: readOptionalEnv(env, 'CHROME_PATH'),
    chromeUserDataDir: readOptionalEnv(env, 'CHROME_USER_DATA_DIR'),
    chromeDownloadDir: readOptionalEnv(env, 'CHROME_DOWNLOAD_DIR'),
